...
const navItems = [
  { to: '/', label: 'Khách hàng', icon: 'users', end: true },
  { to: '/analytics', label: 'Thống kê', icon: 'chart' },
    ...
    <div className="flex min-h-screen bg-slate-50">
      ...
      >
        <div className="flex h-16 items-center gap-3 border-b border-slate-200 px-6">
          ...
          <div>
            <p className="text-sm font-bold text-slate-900">CRM System</p>
            <p className="text-xs text-slate-500">Quản lý KH</p>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 p-4">
          ...
          <button
            type="button"
            onClick={logout}
            className="mt-3 w-full cursor-pointer rounded-lg border border-slate-200 px-3 py-2 text-sm text-slate-600 transition-colors hover:bg-slate-50"
          >
            Đăng xuất
          </button>
        </div>
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        <header className="sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-slate-200 bg-white/80 px-4 backdrop-blur-sm lg:px-8">
          <button
            type="button"
